...
namespace SCPAK
{
	public class ModelData
	{
		...
		public ModelData(Stream stream)
		{
			...
			Bones.Capacity = binaryReader.ReadInt32();
			for (int i = 0; i < Bones.Capacity; i++)
			{
				...
				modelBoneData.Transform = new Matrix(binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle());
			}
			Meshes.Capacity = binaryReader.ReadInt32();
			for (int j = 0; j < Meshes.Capacity; j++)
			{
				...
				modelMeshData.BoundingBox = new BoundingBox(new Vector3(binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle()), new Vector3(binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle()));
				for (int k = 0; k < modelMeshData.MeshParts.Capacity; k++)
				{
					...
					modelMeshPartData.BoundingBox = new BoundingBox(new Vector3(binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle()), new Vector3(binaryReader.ReadSingle(), binaryReader.ReadSingle(), binaryReader.ReadSingle()));
				}
			}
			Buffers.Capacity = binaryReader.ReadInt32();
			for (int l = 0; l < Buffers.Capacity; l++)
			{
				ModelBuffersData modelBuffersData = new ModelBuffersData();
				Buffers.Add(modelBuffersData);
